...
if __name__ == "__main__":
    ...
    build(
        ...
        dots={
            "ear":(0.46,0.11), "neck":(0.515,0.19), "thoracic":(0.535,0.31),
            "lumbar":(0.535,0.42), "pelvis":(0.525,0.49), "hipjoint":(0.50,0.525),
            "knee":(0.475,0.72), "ankle":(0.455,0.92),
        },
        left_cards=[
            (None,"ear","头",["外耳孔与肩峰在同一垂","直线即为标准中立位。","耳跑到肩峰前方就是头","前引。"]),
    ...
    build(
        ...
        left_cards=[
            (1,"scapula","肩胛骨",["两侧肩胛对称贴于胸","廓，内侧缘与脊柱距离","适中。过近为后缩，过","远为前伸。"]),
            (2,"pelvis","骨盆",["两侧髂后上棘在同一水","平，无高低差或前后旋","转，需与正面评估交叉","验证。"]),
            (3,"foot","足",["两侧跟腱应与地面垂","直，观察有无足内翻或","足外翻。"]),
        ],
        right_cards=[
            (4,"spine","脊柱",["颈椎、胸椎、腰椎的棘","突应在一条直线上，没","有侧弯或旋转。"]),
            (5,"femur","股骨",["两侧股骨内外髁到身体","中线的距离应相等。内","侧缘靠近为内旋，外侧","缘靠近为外旋。"]),
            (6,"tibia","胫骨",["两侧胫骨内外踝到中线","的距离应相等，据此判","断小腿有无内外旋。"]),
        ],
