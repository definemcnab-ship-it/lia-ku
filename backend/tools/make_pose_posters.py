...
if __name__ == "__main__":
    ...
    build(
        ...
        dots={
            ...
            "pelvis":(0.490,0.485), "knee":(0.45,0.70), "leg":(0.55,0.74),
            "foot":(0.490,0.875),
        },
        left_cards=[
            (None,"shoulder","肩",["锁骨呈柔和的小倒「八」","字，两侧肩峰等高；据此","观察有无高低肩、圆肩。"]),
            (None,"ribs","肋骨架",["两侧肋骨下角在同一水","平线，肋廓与骨盆处于同","一冠状面、上下对齐。高","低不平多与脊柱侧弯有","关，前后偏移是胸廓旋","转或平移。"]),
            (None,"knee","膝",["大腿中点、髌骨中点、踝","中点应三点一线。髌骨偏","内为膝内扣，偏外为膝外","翻。"]),
            (None,"foot","足",["双脚并拢、脚尖朝前，大","脚趾向外偏移为拇外翻。"]),
        ],
        right_cards=[
    ...
    head_y.clear()
    head_y.update({
        ("L","scapula"):300, ("L","pelvis"):620, ("L","foot"):1165,
    ...
    build(
        ...
        center_x=0.485,
        dots={
            "scapula":(0.43,0.30), "pelvis":(0.448,0.485),
