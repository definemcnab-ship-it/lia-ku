...
export const LIBRARY = [
  {
    id: 'upper-crossed', name: '上交叉综合征', en: 'Upper Crossed', color: 'bg-mint text-teal-800',
  ...
  {
    id: 'lower-crossed', name: '下交叉综合征', en: 'Lower Crossed', color: 'bg-lavender text-purple-800',
    desc: '骨盆前倾、腰椎过度前凸。目标：放松髂腰肌与竖脊肌，强化臀大肌与核心。',
    exercises: [
      { name: '臀桥', dur: '3 组 × 15 次', level: '基础', lc: 'bg-green-100 text-green-700',
        steps: ['仰卧屈膝，双脚与髋同宽', '收紧臀部抬起骨盆', '顶端停留 1 秒', '逐节落下脊柱'],
        breath: '抬起吐气，落下吸气', tip: '用臀部发力而非腰部。' },
      { name: '死虫式', dur: '3 组 × 12 次', level: '进阶', lc: 'bg-orange-100 text-orange-700',
        steps: ['仰卧，手臂指向天花板', '对侧手脚缓慢伸出', '下背始终贴地', '换边交替'],
        breath: '伸出吐气，收回吸气', tip: '腰部一旦离地就缩小幅度。' },
      { name: '髂腰肌弓步拉伸', dur: '2 组 × 30 秒', level: '基础', lc: 'bg-green-100 text-green-700',
  ...
  },
  {
    ...
    exercises: [
      { name: '腹式呼吸激活', dur: '3 组 × 10 次', level: '基础', lc: 'bg-green-100 text-green-700',
        steps: ['仰卧屈膝，双手放于腹部', '吸气腹部鼓起', '吐气时收紧下腹、肚脐内收', '感受腹横肌收缩'],
        breath: '4 秒吸、6 秒吐，缓慢绵长', tip: '产后需经医生评估后再训练。' },
      { name: '脚跟滑动', dur: '3 组 × 10 次', level: '进阶', lc: 'bg-orange-100 text-orange-700',
  ...
  },
  {
    ...
    exercises: [
      { name: '猫牛式', dur: '3 组 × 10 次', level: '基础', lc: 'bg-green-100 text-green-700',
        steps: ['四足跪姿，手腕在肩下', '吸气塌腰抬头（牛）', '吐气拱背低头（猫）', '脊柱逐节活动'],
        breath: '随动作节奏配合呼吸', tip: '动作轻柔，活动度优先。' },
      { name: '单侧侧平板', dur: '2 组 × 20 秒', level: '挑战', lc: 'bg-red-100 text-red-700',
        steps: ['侧卧，肘在肩下支撑', '抬髋使身体成直线', '保持核心收紧', '换边时间一致'],
        breath: '保持均匀呼吸不憋气', tip: '凹侧多练有助对称，遵专业指导。' },
    ],
  },
  {
    id: 'shoulder', name: '高低肩 / 翼状肩胛', en: 'Shoulder Imbalance', color: 'bg-mint text-teal-800',
    desc: '双肩高低不一、肩胛内侧翘起。目标：强化前锯肌与下斜方，建立肩胛稳定。',
    exercises: [
      { name: '靠墙天使', dur: '3 组 × 12 次', level: '基础', lc: 'bg-green-100 text-green-700',
        steps: ['后背贴墙，手臂呈 W', '手臂沿墙上滑成 Y', '全程手背贴墙', '缓慢下滑还原'],
        breath: '上滑吸气，下滑吐气', tip: '腰部贴墙，避免拱起。' },
      { name: '前锯肌推墙', dur: '3 组 × 15 次', level: '进阶', lc: 'bg-orange-100 text-orange-700',
        steps: ['俯身手撑墙', '保持手肘伸直', '主动外推使上背隆起', '回收使肩胛靠拢'],
        breath: '前推吐气，回收吸气', tip: '感受肩胛"包住"肋骨。' },
    ],
  },
  {
    id: 'leg', name: '膝超伸 / X·O 型腿', en: 'Leg Alignment', color: 'bg-lavender text-purple-800',
    desc: '膝关节过伸或腿型不正。目标：强化臀中肌与腘绳肌，改善下肢力线。',
    exercises: [
      { name: '蚌式开合', dur: '3 组 × 15 次', level: '基础', lc: 'bg-green-100 text-green-700',
        steps: ['侧卧屈膝，双脚并拢', '上侧膝盖向上打开', '骨盆保持稳定不后翻', '控制还原'],
        breath: '打开吐气，还原吸气', tip: '感受臀部外侧发力。' },
      { name: '靠墙静蹲', dur: '3 组 × 30 秒', level: '进阶', lc: 'bg-orange-100 text-orange-700',
